...
function AlignSelf(): JSX.Element {
  return <View>
    <View className={clnx(['margin_box', 'font-size_75'])}>
      <View className={clnx(['padding1', 'yellow-bg2'])}>默认: auto 继承父元素的align-items属性，如果没有父元素，则等同于stretch</View>
    ...
    <View className={clnx(['margin_box', 'font-size_75'])}>
      <View className={clnx(['padding1', 'yellow-bg2'])}>该属性可能取6个值，除了auto，其他都与align-items属性完全一致。</View>
      <View className={clnx(['flex', 'flex-column', 'blue-bg3', 'padding_10', 'max-height15', 'scroll'])}>
        <View className={clnx(['flex', 'self-start', 'height2', 'width2', 'borderW', 'blue-bg2', 'margin_10', 'align-center', 'padding3', 'flex-shrink_0', 'width5'])}>
          <Text className={clnx([
            'withe', 'font-size_75', 'line-height1', 'margin_auto', 'text_center'])}>flex-start</Text>
        </View>
        <View className={clnx(['flex', 'self-center', 'height2', 'width2', 'borderW', 'blue-bg2', 'margin_10', 'align-center', 'padding3', 'flex-shrink_0', 'width5'])}>
          <Text className={clnx([
            'withe', 'font-size_75', 'line-height1', 'margin_auto', 'text_center'])}>center</Text>
        </View>
        <View className={clnx(['flex', 'self-end', 'height2', 'width2', 'borderW', 'blue-bg2', 'margin_10', 'align-center', 'padding3', 'flex-shrink_0', 'width5'])}>
          <Text className={clnx([
            'withe', 'font-size_75', 'line-height1', 'margin_auto', 'text_center'])}>flex-end</Text>
        </View>
        <View className={clnx(['flex', 'self-stretch', 'height2', 'width_auto', 'borderW', 'blue-bg2', 'margin_10', 'align-center', 'padding3', 'flex-shrink_0'])}>
          <Text className={clnx([
            'withe', 'font-size_75', 'line-height1', 'margin_auto', 'text_center'])}>flex-stretch</Text>
        </View>
      </View>
    </View>
    <View className={clnx(['margin_box', 'font-size_75'])}>
      <View className={clnx(['padding1', 'yellow-bg2'])}>baseline</View>
